...
<title>Canada Wide Car Rental Service - Employee: Search Service Records</title>
</head>
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
                ...
                echo "<table class='search_table2'>
                        <tr> <th> Invoice No: " . $row["Invoice_no"]. "</th> </tr> <tr> <td> <b> Cost: $ </b>" . 
                        $row["Cost"] . "</th> </tr> <tr> <td> <b> VIN: </b>" . 
                        $row["VIN"] . "</th> </tr> <tr> <td> <b> Start Date: </b>" . 
                        $row["Start_date"] . "</td> </tr> <tr> <td> <b> End Date: </b>" . $row["End_date"] . 
                        "</td> </tr> <tr> <td> <b> Type of Service: </b>" . $row["Type_of_service"] . 
                        "</td> </tr> <tr> <td> <div class = 'edit'> <b> Scheduled Maintenance: </b>" . 
                        $row["Scheduled_maintenance"] . 
                        "<button class= 'editbutton' text-align=left type='button' onclick='window.location.href='serv_rec_edit.php''> Edit </button>  
                        <button class= 'removebutton' text-align=left type='button' onclick='window.location.href='serv_rec_remove.php''> Cancel Reservation </button>
...
<footer>
  ...
  <tr>
    <td>
    <button class= "backbutton" text-align=left type="button" onclick="window.location.href='service_recs.php'"> Back</button>  
</td>
<td>
</td>
<td>
