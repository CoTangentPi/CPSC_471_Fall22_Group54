...
<title>Canada Wide Car Rental Service - Owner: Add Lease</title>
</head>
...
<div>
    <form action='add_lease_post.php' method='post'>
        <table class = "lease_table">
            ...
            <tr>
                ...
                <td><button class= "submitbutton" type="submit" name="submit" value="Submit">Add Lease</button></td>
            </tr>
            </table>
    </form>
