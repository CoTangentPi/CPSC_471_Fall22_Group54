...
<div>
    ...
    <form action='owner_emp_add2_post.php' method='post'>
        <table>
            <tr>
                <td>First Name:</td>
            ...
            <tr>
                <td>SIN:</td>
                <td><input type = "text" name = "SIN" required pattern = "[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]"></td>
            </tr>
            <tr>
                <td>Branch Number:</td>
                <td><select name = "Branch" id = "Branch" required><?php
                      $con = mysqli_connect("localhost","root","","cwcrs_db");
                      if(!$con) {
                          exit("An error connecting occurred." .mysqli_connect_errno());
                      } else { }
        ...
        <option value = "YT" > Yukon </option>
            ...
            <tr>
                <td>Confirm Employee Password:</td>
